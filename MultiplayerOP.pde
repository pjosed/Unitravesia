void escenario2(){ /////////////////////////////////////////////// ESCOGER ESCENARIO EN MULTIPLAYER
...
void personajes2() { ////////////////////////////// JUGADOR 1 SELECCIONANDO PERSONAJE
  cl1=cl1+10;
  cl2=cl2+10;
  cl3=cl3+10;
  if (cl1>256) {
...
void personajes3() { //////////////////////////////// JUGADOR 2 SELECCIONANDO PERSONAJE
  cl1=cl1+10;
  cl2=cl2+10;
  cl3=cl3+10;
  if (cl1>256) {
...
void pausa(){
  background(0);
  textopausa="Juego Pausado, pulse p para jugar";
  fill(#EADADA);
  text(textopausa, width/2, height/2);
